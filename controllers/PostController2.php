...
//
//                    if ($model->save() && $path = $formUpload->upload()) {
...
//
//          }
//          return $this->render('create', ['model' => $model, 'formUpload' => $formUpload]);
//     }
//
//     /**
...
//          $formUpload = new FormUpload();
//
//          $existingImage = $model->imageFile;
//
//          if ($this->request->isPost) {
//               if ($model->load(Yii::$app->request->post())) {
//                    $formUpload->imageFile = UploadedFile::getInstance($formUpload, 'imageFile');
//
//                    if ($formUpload->imageFile) {
//                         if ($path = $formUpload->upload()) {
//                              $model->imageFile = $path;
//                              $model->save();
//                              return $this->redirect(['view', 'id' => $model->id]);
//                         } else {
...
//                    $formUpload->imageFile = UploadedFile::getInstance($formUpload, 'imageFile');
//
//                    if ($model->save() && $formUpload->upload()) {
//                         return $this->redirect(['view', 'id' => $model->id]);
//                    }
//               }
//
